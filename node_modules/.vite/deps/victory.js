  ...
  const traverseChildren = (childArray, names, parent) => {
    return childArray.reduce((memo, child, index) => {
      ...
      if (child.props && child.props.children) {
        ...
        const nestedChildren = child.type && child.type.role === "stack" && isFunction(child.type.getChildren) ? child.type.getChildren(childProps) : import_react6.default.Children.toArray(child.props.children).map((c) => {
          const nestedChildProps = Object.assign({}, c.props, (0, import_pick.default)(childProps, sharedProps));
          return import_react6.default.cloneElement(c, nestedChildProps);
        });
...
var getStyles2 = (style, props) => {
  ...
  const getSingleStyle = (s) => {
    const baseStyles = evaluateStyle(s ? (0, import_defaults6.default)({}, s, defaultStyles) : defaultStyles, props);
    return Object.assign({}, baseStyles, {
      fontSize: getFontSize(baseStyles)
    });
  };
  return Array.isArray(style) && !(0, import_isEmpty.default)(style) ? style.map((s) => getSingleStyle(s)) : getSingleStyle(style);
};
var getBackgroundStyles = (style, props) => {
  if (!style) {
    return void 0;
  }
  return Array.isArray(style) && !(0, import_isEmpty.default)(style) ? style.map((s) => evaluateStyle(s, props)) : evaluateStyle(style, props);
};
...
var VictoryTransition = class extends import_react14.default.Component {
  ...
  getClipWidth(props, child) {
    const getDefaultClipWidth = () => {
      const range2 = getRange(child.props, "x");
      return range2 ? Math.abs(range2[1] - range2[0]) : props.width;
    };
...
var VictoryClipContainer = class extends import_react17.default.Component {
  ...
  getClipValue(props, axis) {
    ...
    const range2 = getRange(props, axis);
    return range2 ? Math.abs(range2[0] - range2[1]) || void 0 : void 0;
  }
  getTranslateValue(props, axis) {
    ...
    const range2 = getRange(props, axis);
    return range2 ? Math.min(...range2) : void 0;
  }
  render() {
  ...
  class AddEventsMixin extends WrappedComponent {
    ...
    getStateChanges(props) {
      ...
      const getState = (key, type) => {
        const result = (0, import_defaults10.default)({}, this.getEventState(key, type), this.getSharedEventState(key, type));
    ...
    getBaseProps(props, getSharedEventState) {
      ...
      const baseParentProps = (0, import_defaults10.default)({}, parentState, sharedParentState);
      ...
      const modifiedProps = (0, import_defaults10.default)({}, parentProps, props);
    ...
    getComponentProps(component, type, index) {
      ...
      if (this.hasEvents) {
        ...
        const componentProps = (0, import_defaults10.default)({
          index,
          key: id
        }, this.getEventState(key, type), this.getSharedEventState(key, type), currentProps, baseProps3, {
          id
        });
        const events = (0, import_defaults10.default)({}, getPartialEvents(baseEvents, key, componentProps), componentProps.events);
...
function padDomain(domain, props, axis) {
  ...
  const range2 = getRange(props, currentAxis);
  const rangeExtent = Math.abs(range2[0] - range2[1]);
...
function findAxisComponents(childComponents, predicate) {
  const predicateFunction = predicate || identity2;
...
function modifyProps2(props, fallbackProps22) {
  ...
  const axisTheme = (0, import_defaults11.default)({}, props.theme[role], props.theme.axis);
...
var useAnimationState = function(initialState) {
  ...
  const getAnimationProps = import_react31.default.useCallback((props, child, index) => {
  ...
  const setAnimationState = import_react31.default.useCallback((props, nextProps) => {
    ...
    if (props.animate.parentState) {
      ...
      const newState = (0, import_defaults12.default)({
        oldProps,
        nextProps
...
function getWidth(props, groupLength, seriesLength) {
  ...
  const range2 = horizontal ? getRange(props, "y") : getRange(props, "x");
  const extent2 = Math.abs(range2[1] - range2[0]);
...
function getChildStyle(child, index, calculatedProps) {
  ...
  const dataStyle = (0, import_defaults13.default)({}, childStyle.data, Object.assign({}, dataWidth, style.data, defaultColor));
  const labelsStyle = (0, import_defaults13.default)({}, childStyle.labels, style.labels);
  return {
    ...childStyle,
    parent: style.parent,
    data: dataStyle,
...
var getCalculatedValues = (props) => {
  ...
  const scale = {
    x: scale_exports.getBaseScale(props, "x").domain(domain.x).range(props.horizontal ? range2.y : range2.x),
    y: scale_exports.getBaseScale(props, "y").domain(domain.y).range(props.horizontal ? range2.x : range2.y)
  };
...
var getCalculatedValues2 = (props) => {
  ...
  const scale = {
    x: props.domain && props.domain.x ? scale_exports.getBaseScale(props, "x").domain(props.domain.x).range(props.horizontal ? range2.y : range2.x) : xAxisScale,
    y: props.domain && props.domain.y ? scale_exports.getBaseScale(props, "y").domain(props.domain.y).range(props.horizontal ? range2.x : range2.y) : yAxisScale
  };
...
var getAngularWidth = (props, width) => {
  ...
  const range2 = scale.y.range();
  const r = Math.max(...range2);
...
var getStyles4 = function(props, styleObject) {
  ...
  const labelStyles = (0, import_defaults15.default)({}, style.labels, getLabelStyle(props, styleObject));
  const boxStyles = (0, import_defaults15.default)({}, style.boxes, styleObject.boxes);
  const whiskerStyles = (0, import_defaults15.default)({}, style.whiskers, styleObject.whiskers);
  return {
    boxes: boxStyles,
    labels: labelStyles,
...
var Helpers = {
  ...
  getDomainBox(props, fullDomain, selectedDomain) {
    ...
    const fullDomainObject = (0, import_defaults16.default)({}, fullDomain, props.domain);
    const selectedDomainObject = (0, import_defaults16.default)({}, selectedDomain, fullDomainObject);
  ...
  panBox(props, point3) {
    ...
    const brushDimension = this.getDimension(props);
    const brushDomain = (0, import_defaults16.default)({}, props.brushDomain, domain);
    const fullDomain = (0, import_defaults16.default)({}, props.fullDomain, domain);
    const {
      x1,
      x2,
      y1,
  ...
  onMouseDown(evt, targetProps) {
    ...
    const brushDomain = (0, import_defaults16.default)({}, targetProps.brushDomain, domain);
...
function brushContainerMixin(Base) {
  ...
  return _a = class extends Base {
    ...
    getSelectBox(props, coordinates) {
      ...
      return x2[0] !== x2[1] && y2[0] !== y2[1] ? import_react39.default.cloneElement(brushComponent, {
        key: `${name}-brush`,
    ...
    getHandles(props, domain) {
      ...
      const style = (0, import_defaults17.default)({}, handleComponentStyle, handleStyle);
    ...
    getRect(props) {
      ...
      const brushDomain = (0, import_defaults17.default)({}, props.brushDomain, props.domain);
      const domain = (0, import_react_fast_compare4.default)(brushDomain, cachedBrushDomain) ? (0, import_defaults17.default)({}, currentDomain, brushDomain) : brushDomain;
...
var getScale3 = (props) => {
  ...
  const range2 = helpers_exports.getRange(props, dimension);
  const domain = domain_exports.getDomainFromProps(props, dimension) || [0, 1];
  fallbackScale.range(range2).domain(domain);
...
var toDomain = (props, range2) => {
  const scale = getScale3(props);
  return [scale.invert(Math.min(...range2)), scale.invert(Math.max(...range2))];
};
...
var getActiveHandle = (props, position, range2) => {
  const width = props.handleWidth / 2;
  const dimension = getDimension(props);
  const getHandle = (type) => {
    const base = {
      min: dimension === "x" ? Math.min(...range2) : Math.max(...range2),
      max: dimension === "x" ? Math.max(...range2) : Math.min(...range2)
    };
...
var VictoryBrushLine = class extends import_react40.default.Component {
  getRectDimensions(props, brushWidth, domain) {
    ...
    const dimension = getDimension(props);
    const range2 = toRange(props, domain || getBrushDomain(brushDomain, getFullDomain(props)));
  ...
  getHandleDimensions(props) {
    ...
    const range2 = toRange(props, domain);
    const defaultX = Math.min(x1, x2) - brushWidth / 2;
    const defaultY = Math.min(y1, y2) - brushWidth / 2;
    const x3 = {
      min: dimension === "x" ? Math.min(...range2) - handleWidth / 2 : defaultX,
      max: dimension === "x" ? Math.max(...range2) - handleWidth / 2 : defaultX
    };
    const y3 = {
      min: dimension === "y" ? Math.max(...range2) - handleWidth / 2 : defaultY,
      max: dimension === "y" ? Math.min(...range2) - handleWidth / 2 : defaultY
    };
  ...
  return props.disable ? void 0 : [{
    ...
    eventHandlers: {
      onMouseEnter: (evt, targetProps) => {
        ...
        const range2 = toRange(targetProps, currentDomain);
        const activeHandle = allowResize && getActiveHandle(targetProps, position, range2);
        const activeBrushes = {
          brushArea: !targetProps.brushDomain,
          brush: withinBound(position, range2) && !(0, import_react_fast_compare5.default)(fullDomain, currentDomain),
      ...
      onMouseDown: (evt, targetProps) => {
        ...
        } else if (withinBound(position, range2) && !(0, import_react_fast_compare5.default)(fullDomain, currentDomain)) {
          return [{
            mutation: () => ({
              isPanning: allowDrag,
              startPosition: position,
      ...
      onMouseMove: (evt, targetProps) => {
        ...
        if (allowDrag && isPanning) {
          ...
          const range2 = panBox(targetProps, position);
          const currentDomain = toDomain(targetProps, range2);
          const startPosition = Math.max(...range2) >= Math.max(...fullRange) || Math.min(...range2) <= Math.min(...fullRange) ? targetProps.startPosition : position;
          const mutatedProps = {
            startPosition,
            isPanning: true,
            brushDomain: currentDomain,
          ...
          const handle = targetProps.activeHandle && getActiveHandle(targetProps, position, range2) === "both" ? oppositeHandle : targetProps.activeHandle;
          if (!handle) {
            currentDomain = toDomain(targetProps, [targetProps.startPosition, position]);
          } else {
            const rangeMax = dimension === "x" ? Math.max(...range2) : Math.min(...range2);
            const rangeMin = dimension === "x" ? Math.min(...range2) : Math.max(...range2);
...
var Candle = (props) => {
  const modifiedProps = evaluateProps10({
    ...defaultProps10,
    ...props
  });
  const {
  ...
  const wickStyle = (0, import_defaults19.default)({
...
var getStyles5 = function(props, style, defaultStyles2) {
  ...
  const labelStyle = (0, import_defaults20.default)({}, style.labels, defaultLabels);
  return {
...
var getBaseProps5 = (initialProps, fallbackProps22) => {
  ...
  return data.reduce((childProps, datum, index) => {
    ...
    const extendedProps = (0, import_defaults20.default)(Object.assign({}, dataProps), props);
    childProps[eventKey] = {
      data: dataProps
    };
    if (labels) {
...
var CanvasBar = (props) => {
  ...
  const draw = import_react44.default.useCallback((ctx, path) => {
...
var VictorySharedEvents = class extends import_react48.default.Component {
  ...
  getContainer(props, baseProps3, events) {
    ...
    const parentProps = (0, import_defaults21.default)({}, this.getEventState("parent", "parent"), containerProps, baseProps3.parent, {
      children
    });
    const containerEvents = (0, import_defaults21.default)({}, events_exports.getPartialEvents(parentEvents, "parent", parentProps), containerProps.events);
...
var getStyleObject2 = (props) => {
  ...
  const mergeStyles = () => {
    const styleNamespaces = ["axis", "axisLabel", "grid", "parent", "tickLabels", "ticks"];
    return styleNamespaces.reduce((memo, curr) => {
      memo[curr] = (0, import_defaults22.default)({}, specificAxisStyle == null ? void 0 : specificAxisStyle[curr], generalAxisStyle == null ? void 0 : generalAxisStyle[curr]);
      return memo;
    }, {});
  };
  return generalAxisStyle && specificAxisStyle ? mergeStyles() : specificAxisStyle || generalAxisStyle;
...
var getScale4 = (props) => {
  ...
  const range2 = getRange2(props, axis);
  scale.range(range2);
  scale.domain(domain);
  return scale;
};
...
function getCalculatedProps2(initialProps, childComponents) {
  ...
  const scale = {
    x: baseScale.x.domain(domain.x).range(horizontal ? range2.y : range2.x),
    y: baseScale.y.domain(domain.y).range(horizontal ? range2.x : range2.y)
  };
...
function getChildren(props, childComponents, calculatedProps) {
  ...
  const parentName = props.name || "chart";
  return children.filter(import_react50.default.isValidElement).map((child, index) => {
    const role = child.type && child.type.role;
    const style = Array.isArray(child.props.style) ? child.props.style : (0, import_defaults23.default)({}, child.props.style, {
      parent: baseStyle
    });
    const childProps = getChildProps(child, props, newCalculatedProps);
    const name = child.props.name || `${parentName}-${role}-${index}`;
    const newProps = (0, import_defaults23.default)({
      horizontal,
      height,
      polar,
      theme,
...
var VictoryChartImpl = (initialProps) => {
  const propsWithDefaults = import_react51.default.useMemo(() => ({
    ...defaultProps11,
    ...initialProps
  }), [initialProps]);
  const role = "chart";
  ...
  const container = import_react51.default.useMemo(() => {
    if (standalone) {
      const defaultContainerProps = (0, import_defaults24.default)({}, containerComponent.props, containerProps, user_props_exports.getSafeUserProps(propsWithDefaults));
...
var VictoryTooltip = class extends import_react53.default.Component {
  ...
  getStyles(props) {
    ...
    const baseLabelStyle = Array.isArray(props.style) ? props.style.map((s) => (0, import_defaults25.default)({}, s, defaultLabelStyles)) : (0, import_defaults25.default)({}, props.style, defaultLabelStyles);
    const defaultFlyoutStyles = theme && theme.tooltip && theme.tooltip.flyoutStyle ? theme.tooltip.flyoutStyle : {};
    const baseFlyoutStyle = props.flyoutStyle ? (0, import_defaults25.default)({}, props.flyoutStyle, defaultFlyoutStyles) : defaultFlyoutStyles;
...
function voronoiContainerMixin(Base) {
  ...
  return _a = class extends Base {
    ...
    getLabelPosition(props, labelProps, points) {
      ...
      const point3 = this.getPoint(points[0]);
    ...
    getStyle(props, points, type) {
      ...
      return points.reduce((memo, datum, index) => {
        const labelProps = (0, import_defaults26.default)({}, componentProps, {
          datum,
          active: true
        });
        ...
        const style = helpers_exports.evaluateStyle((0, import_defaults26.default)({}, componentStyle, baseStyle, themeStyles[type]), labelProps);
    ...
    getLabelProps(props, points) {
      ...
      const text = points.reduce((memo, datum2) => {
        const labelProps2 = (0, import_defaults26.default)({}, componentProps, {
          datum: datum2,
          active: true
        });
      ...
      const labelProps = (0, import_defaults26.default)({
...
var RawZoomHelpers = {
  ...
  getScaledDomain(currentDomain, factor, percent) {
    const [from, to] = currentDomain;
    const range2 = Math.abs(to - from);
    const diff = range2 - range2 * factor;
  ...
  getDomainScale(domain, scale, axis) {
    ...
    const range2 = scale[axis].range();
    const plottableWidth = Math.abs(range2[0] - range2[1]);
  ...
  return _a = class extends Base {
    ...
    modifyChildren(props) {
      ...
      return childComponents.map((child) => {
        ...
        const originalDomain = (0, import_defaults28.default)({}, props.originalDomain, props.domain);
        const zoomDomain = (0, import_defaults28.default)({}, props.zoomDomain, props.domain);
        const cachedZoomDomain = (0, import_defaults28.default)({}, props.cachedZoomDomain, props.domain);
        let domain;
...
var SelectionHelpersClass = class {
  constructor() {
    ...
    __publicField(this, "onMouseUp", (evt, targetProps) => {
      ...
      const callbackMutation = selectedData && helpers_exports.isFunction(targetProps.onSelection) ? targetProps.onSelection(selectedData, bounds, (0, import_defaults29.default)({}, mutatedProps, targetProps)) : {};
      const parentMutation = [{
        target: "parent",
        mutation: () => mutatedProps
      }];
...
function selectionContainerMixin(Base) {
  ...
  return _a = class extends Base {
    ...
    getRect(props) {
      ...
      return y2 && x2 && x1 && y1 ? import_react59.default.cloneElement(selectionComponent, {
        key: `${name}-selection`,
        x: x3,
        y: y3,
        width,
...
function cursorContainerMixin(Base) {
  ...
  return _a = class extends Base {
    ...
    getPadding(props) {
      if (props.padding === void 0) {
        const child = props.children.find((c) => {
          return (0, import_isObject4.default)(c.props) && c.props.padding !== void 0;
        });
    ...
    getCursorElements(props) {
      ...
      if (cursorLabel) {
        let labelProps = (0, import_defaults30.default)({
          active: true
...
function getCalculatedProps3(initialProps, childComponents) {
  ...
  const scale = {
    x: baseScale.x.domain(domain.x).range(props.horizontal ? range2.y : range2.x),
    y: baseScale.y.domain(domain.y).range(props.horizontal ? range2.x : range2.y)
  };
...
function pixelsToValue(props, axis, calculatedProps) {
  ...
  const range2 = calculatedProps.range[currentAxis];
  const domainExtent = Math.max(...domain) - Math.min(...domain);
  const rangeExtent = Math.max(...range2) - Math.min(...range2);
...
function getAngularWidth2(props, calculatedProps) {
  ...
  const angularRange = Math.abs(range2.x[1] - range2.x[0]);
  const r = Math.max(...range2.y);
...
var VictoryGroupBase = (initialProps) => {
  ...
  const propsWithDefaults = import_react64.default.useMemo(() => ({
    ...defaultProps14,
    ...initialProps
  }), [initialProps]);
  const props = getProps2(propsWithDefaults);
  ...
  const container = import_react64.default.useMemo(() => {
    if (standalone) {
      const defaultContainerProps = (0, import_defaults32.default)({}, containerComponent.props, containerProps, userProps);
...
var getLabelStyles = (props) => {
  ...
  return data.map((datum, index) => {
    const baseLabelStyles3 = (0, import_defaults33.default)({}, datum.labels, style.labels);
...
var getTitleStyle = (props) => {
  ...
  return Array.isArray(componentStyle) ? componentStyle.map((obj) => (0, import_defaults33.default)({}, obj, baseStyle, anchors)) : (0, import_defaults33.default)({}, componentStyle, baseStyle, anchors);
};
...
var getBaseProps9 = (initialProps, fallbackProps22) => {
  ...
  return groupedData.reduce((childProps, datum, i) => {
    ...
    const dataStyle = (0, import_defaults33.default)({}, datum.symbol, style.data, {
      fill: color
    });
...
var getBaseProps11 = (initialProps, fallbackProps22) => {
  ...
  return slices.reduce((childProps, slice, index) => {
    const datum = (0, import_defaults34.default)({}, data[index], {
...
function getCalculatedProps4(initialProps, childComponents) {
  ...
  const clonedChildren = children.map((c, i) => {
    return import_react72.default.cloneElement(c, {
      data: datasets[i]
    });
  });
  const domain = {
...
var VictoryStackBase = (initialProps) => {
  ...
  const propsWithDefaults = import_react73.default.useMemo(() => ({
    ...defaultProps17,
    ...initialProps
  }), [initialProps]);
  const {
  ...
  const container = import_react73.default.useMemo(() => {
    if (standalone) {
      const defaultContainerProps = (0, import_defaults36.default)({}, containerComponent.props, containerProps, userProps);
...
var getVoronoi = (props, range2, scale) => {
  const minRange = [Math.min(...range2.x), Math.min(...range2.y)];
  const maxRange = [Math.max(...range2.x), Math.max(...range2.y)];
...
var getCalculatedValues13 = (props) => {
  ...
  const voronoi = getVoronoi(props, range2, scale);
